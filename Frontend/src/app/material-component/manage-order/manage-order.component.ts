...
export class ManageOrderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //get all the categories for dropdown menu in add product page
  ...
  validateProductAdd() {
    if (this.manageOrderForm.controls['total'].value === 0 || this.manageOrderForm.controls['total'] === null
  ...
  add() {
    ...
    var productName = this.dataSource.find((e: { id: number }) => e.id == formData.productId.id);
    if (productName === undefined) {
      this.totalAmount = this.totalAmount + formData.total;
      this.dataSource.push({
        id: formData.productId.id, name: formData.productName.name, category: formData.category.name,
